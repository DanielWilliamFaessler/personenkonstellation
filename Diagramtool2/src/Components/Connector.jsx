...
class Connector extends Component {
    ...
    getConnectorPoints = stuff => {
        const points = stuff.points;
        const from = stuff.from
        const to = stuff.to
        const mouseX = stuff.mouseX
        const mouseY = stuff.mouseY
        ...
        if (stuff.type === 'FromAndTo') {
            if (
                ...
                //only works for rectangle because the calculation for origin is different for circleboy and rectangle
                const dy =
                    to.attrs.y +
                    to.attrs.height / 2 -
